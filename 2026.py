...
input_times = 32             # Anzahl der Lerndurchläufe
...
#        INPUT_akt[i] = Input[i,z]
    ...
    stufen_wert = numpy.sin(2*math.pi/(alpha_takt)*z)+alpha_bias
    #print("stufen_wert= ", stufen_wert) 
