...
input_times = 5         # Anzahl der Lerndurchläufe
#learning_rate = 0.1     # learning rate
stufen_wert = 0.3       # Stufenwert der Sprungfunktion
...
for z in range(input_times): # input_times = Anzahl der Durchläufe
    ...
    # Refraktionszeit = 3ms; alpha-Welle ca 100ms (=10Hz); ß-Welle ca. 30Hz => Lernschritte zwischen 30 - 90 Schritte (alpha - ß Welle)
    for l in range (int(1*math.pi)*10):
        print(l)    
    #    Schritt = numpy.sin(l)
