...
class dynNN:
    def __init__(self,inputnodes, hiddennodes, outputnodes,  stufenwert, maxverzoegerung):
...
n = dynNN(input_nodes, hidden_nodes, output_nodes, stufen_wert, max_verzoeg)
n.status()
